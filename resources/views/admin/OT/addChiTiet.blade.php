...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <form id="addChiTiet">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="MaNV" type="number" class="form-control" name="MaNV" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="SoPhieu" type="number" class="form-control" name="SoPhieu" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="SoGio" type="number" class="form-control " name="SoGio" required>
                                </div>
                            </div>
    ...
    <script>
        document.getElementById('addChiTiet').addEventListener('submit', function(event) {
            event.preventDefault();
    
            const formData = new FormData(this);
            axios.post('/admin/OT/chitiet/add', {
