...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <form id="suaPhongBan">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="MaNV" type="text" class="form-control" name="TenPhongBan" value="{{$phongban->TenPhongBan}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="SoGio" type="text" class="form-control " value="{{$phongban->DienThoaiPhongBan}}" name="DienThoaiPhongBan" required>
                                </div>
                            </div>
    ...
    <script>
        document.getElementById('suaPhongBan').addEventListener('submit', function(event) {
            event.preventDefault();
    
            const formData = new FormData(this);
            axios.post('/admin/department/edit', {
