...
@section('content')
    <div class="container py-3">
        <form id="addLoaiHopDong">
            ...
            <div class="form-group">
                ...
                <input type="text" value="" class="form-control" id="TenLoaiHopDong" name="TenLoaiHopDong" required>
            </div>
            <div class="form-group">
                <label for="ThoiHanHopDong">Thời hạn hợp đồng</label>
                <input type="text" class="form-control" id="ThoiHanHopDong" name="ThoiHanHopDong" required>
            </div>
    ...
    <script>
        document.getElementById('addLoaiHopDong').addEventListener('submit', function(event) {
            ...
            axios.post('/admin/contract-type/add', {
